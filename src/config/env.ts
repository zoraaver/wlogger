...
export const CLIENT_PRODUCTION_URL = process.env
  .CLIENT_PRODUCTION_URL as string;
export const CLIENT_DEVELOPMENT_URL = process.env
  .CLIENT_DEVELOPMENT_URL as string;
